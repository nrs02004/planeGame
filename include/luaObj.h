...
public:
    ...
    Ship_dat(float _speed, float _life, float _cool_down_length, std::string _name, float _x, float _y) : speed(_speed), life(_life), cool_down_length(_cool_down_length), name(_name), x(_x), y(_y) {}
};
