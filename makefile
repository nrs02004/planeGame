...
gameApp: main.o action.o display.o event.o image.o ship.o bullet.o enemyShip.o physicalObject.o lua_binding.o level.o layer.o weapon.o powerup.o visible_equipment.o
	$(CC) -o gameApp $(LIBLUA) main.o display.o event.o ship.o action.o bullet.o enemyShip.o physicalObject.o image.o lua_binding.o level.o layer.o weapon.o powerup.o visible_equipment.o $(FLAGS)
...
visible_equipment.o: $(SRC)visible_equipment.cpp
	$(CC) -c $(SRC)visible_equipment.cpp $(INC)
